...
/*   Updated: 2024/09/28 15:20:18 by gcapa-pe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

// ClapTrap::ClapTrap() : _name("Default"), _hitPoints(10), _energyPoints(10), _attackDamage(5)
// {
//     std::cout << " --- ClapTrap constructor called ---" << std::endl;
// }

ClapTrap::ClapTrap(std::string name) : _name(name), _hitPoints(10), _energyPoints(10), _attackDamage(5)
{
    std::cout << " --- ClapTrap constructor called ---" << std::endl;
}
